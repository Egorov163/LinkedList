...
namespace Test.Model
{
    ...
    public class LinkedList<T> : IEnumerable
    {
        ...
        /// <summary>
        /// Добавить данные после заданного значения.
        /// </summary>
        /// <param name="data">Заданное значение</param>
        /// <param name="target">Добавить данные после этого значения</param>
        public void InsertAfter(T target, T data)
        {
            ...
            {
                // Можно прописать логику, если список пустой, либо ничего не делать,
